...
// ** Store & Actions
import {getList} from '../../../redux/labResultType'
...
const LabResultType = () => {
    ...
    const store = useSelector(state => state.labResultType)
    console.log('LabResultType:', store)
    // ** States
    ...
    const handleDelete = (item) => {
        labResultTypeService.delete(item.uuid).then(() => {
...
// ** Custom Pagination
    ...
    return (
        <Fragment>
            ...
            <AddNewModal open={modal} handleModal={handleModal} setRefreshTable={setRefreshTable}/>
        </Fragment>
    )
}

export default memo(LabResultType)
