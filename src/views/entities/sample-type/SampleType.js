...
// ** Store & Actions
import {getData} from '../../../redux/sampleType'
...
const SampleType = () => {
    ...
    const store = useSelector(state => state.sampleType)
    ...
    const handleDelete = (item) => {
        ...
        sampleTypeService.delete(item.uuid).then(() => {
...
export default memo(SampleType)
