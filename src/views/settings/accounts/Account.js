...
const Account = () => {
    ...
    const handleDelete = (uuid) => {
        console.log('delete Account:item', uuid)
        accountService.delete(uuid).then(() => {
...
// ** Table data to render
    const dataToRender = () => {
        ...
        console.log('Account:dataToRender:', store.data)
...
// ** Custom Pagination
    ...
    return (
        <Fragment>
            ...
            <EditModal open={editModal} item={selectedItem} handleModal={handleEditModal}
