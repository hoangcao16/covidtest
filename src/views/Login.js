...
const ToastContent1 = ({name, role}) => (
    <Fragment>
        ...
        <div className='toastify-body'>
            <span>You have successfully logged in as an {role} user to HL Hospital. Now you can start to explore. Enjoy!</span>
        </div>
    </Fragment>
)
const defaultValues = {
    loginEmail: 'admin@hospital-project.com',
    password: 'snake@@$2a$10$DsJh'
}
const LoginCover = () => {
    const {skin} = useSkin()
    ...
    const onLoginSubmit = () => {
        console.log('handleLoginSubmit:', email, password)
        authService.login(email, password).then(response => {
            ...
            meService.me().then(response1 => {
                ...
                toast.success(
                    <ToastContent1 name={response1.data.payload.name || data.username || 'Phùng Tú'} role={data.role || 'admin'}/>,
        ...
        <div className='auth-wrapper auth-cover'>
            <Row className='auth-inner m-0'>
                <Link className='brand-logo' to='/' onClick={e => e.preventDefault()}>
                    ...
                    <h2 className='brand-text text-primary ms-1'>Hop Luc Hospital</h2>
                </Link>
                    ...
                    <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
                        ...
                        <Form className='auth-login-form mt-2' onSubmit={e => {
                            ...
                            <div className='mb-1'>
                                ...
                                <Input type='email' id='login-email' placeholder='admin@hospital-project.com' autoFocus
                                       value={email}
