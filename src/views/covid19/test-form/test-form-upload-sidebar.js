...
import {Card, CardBody, CardHeader, CardTitle, Input, Label, Row} from 'reactstrap'
import moment from "moment"
import {generateCode, generateCodeWithNumber, seed, random} from '../../../utility/Utils'
                ...
                <CardBody>
                    <div className='patients'>
                        <div className='patient'>
                            ...
                            <div className='patient-item patient-dateCreated'>Ngày thực hiện</div>
                        </div>
                        {
                            patients.map((item, idx) => (
                                <div className='patient'>
                                    ...
                                    <div className='patient-item patient-dateOfBirth'>{item.dateOfBirth}</div>
                                    <div className='patient-item patient-address'>{item.address}</div>
                                    <div className='patient-item patient-address'>{item.phone}</div>
                                    <div className='patient-item patient-address'>{item.session}</div>
                                    <div className='patient-item patient-address'>{item.agency}</div>
